...
var _accountOperations = require("./accountOperations");
...
if (changeInformationForm) changeInformationForm.addEventListener("submit", (e)=>{
    e.preventDefault();
    ...
    (0, _accountOperations.changeInformation)(form, "data");
});
if (userPasswordDataForm) userPasswordDataForm.addEventListener("submit", async (e)=>{
    e.preventDefault();
    ...
    if (!data.passwordConfirm || !data.passwordCurrent || !data.password) return (0, _alertsJs.showAlert)("error", "Please fill one or more field");
    await (0, _accountOperations.changeInformation)(data, "password");
    document.querySelector(".btn--save-password").textContent = "Save password";
    // OPERAZIONE FORM
    e.target.reset();
});

},{"@babel/polyfill":"dTCHC","./mapbox":"3zDlz","./login":"7yHem","./accountOperations":"abXcQ","./alerts.js":"6Mcnf"}],"dTCHC":[function(require,module,exports) {
"use strict";
...
const displayMap = (locations)=>{
    mapboxgl.accessToken = "pk.eyJ1IjoiZmVkZXJpY290ZXN0bm9kZSIsImEiOiJjbG9jcnBtYzcwMDZhMmptbGQxYmU4czhtIn0.a4atZBvr9InBOiAM4t6lKA";
...
var _alertsJs = require("./alerts.js");
async function login(dataInput) {
    try {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"abXcQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "changeInformation", ()=>changeInformation);
var _alertsJs = require("./alerts.js");
async function changeInformation(dataInput, type) {
    ...
    try {
        ...
        (0, _alertsJs.showAlert)("success", "Settings updated");
    } catch (error) {
        (0, _alertsJs.showAlert)("error", error.message);
    }
}

},{"./alerts.js":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["i5p9B","f2QDv"], "f2QDv", "parcelRequire7e89")
